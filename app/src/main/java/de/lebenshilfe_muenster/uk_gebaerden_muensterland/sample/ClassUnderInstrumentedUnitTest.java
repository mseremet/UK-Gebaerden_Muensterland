...
public class ClassUnderInstrumentedUnitTest implements Parcelable {
    ...
    public ClassUnderInstrumentedUnitTest() { }
    ...
    public static final Creator<ClassUnderInstrumentedUnitTest> CREATOR
            = new Creator<ClassUnderInstrumentedUnitTest>() {

        @Override
        public ClassUnderInstrumentedUnitTest createFromParcel(Parcel in) {
            return new ClassUnderInstrumentedUnitTest(in);
        }

        @Override
        public ClassUnderInstrumentedUnitTest[] newArray(int size) {
            return new ClassUnderInstrumentedUnitTest[size];
        }
    };
    ...
    private ClassUnderInstrumentedUnitTest(Parcel in) {
